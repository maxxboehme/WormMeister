...
public class UpdateClock {
	...
	/*
	 * Whether or not the Updater is paused.
	 */
	private boolean isPaused;
	
	/**
	 * Creates a new Updater and sets it's cycles-per-second.
	 * @param cyclesPerSecond The number of cycles that elapse per second.
	 */
	UpdateClock(float cyclesPerSecond) {
	...
	/**
	 * Resets the Updater stats. Elapsed cycles and cycle excess will be reset
